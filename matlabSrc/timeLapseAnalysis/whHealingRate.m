...
healingRateFname = [dirs.healingRate dirs.expname '_healingRate.eps'];
...
% end
% /Users/yishaiazabary/MonolayerKymographs/Sample_DATA/healingRate/Angeles_20150402_14hrs_5min_AA01_7healingRatePlot
% ADDED BY YISHAIA START
saveas(h, [dirs.healingRate dirs.expname 'healingRatePlot.jpg']);
% ADDED BY YISHAIA END
